...
<div style="border-left: 4px solid #8250df; padding-left: 16px; margin: 16px 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji'; color: #24292f; font-size: 14px; line-height: 1.5;">
  
  <!-- Header with Icon and Title -->
  <div style="display: flex; align-items: center; gap: 8px; color: #8250df; font-weight: 600; margin-bottom: 12px;">
    <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" style="fill: currentColor;">
      <path d="M0 1.75C0 .784.784 0 1.75 0h12.5C15.216 0 16 .784 16 1.75v9.5A1.75 1.75 0 0 1 14.25 13H8.06l-2.573 2.573A1.458 1.458 0 0 1 3 14.543V13H1.75A1.75 1.75 0 0 1 0 11.25Zm1.75-.25a.25.25 0 0 0-.25.25v9.5c0 .138.112.25.25.25h2a.75.75 0 0 1 .75.75v2.543l2.543-2.543a.748.748 0 0 1 .53-.22h6.727a.25.25 0 0 0 .25-.25v-9.5a.25.25 0 0 0-.25-.25Zm6.25 2.75a.75.75 0 0 1 .75.75v3.5a.75.75 0 0 1-1.5 0v-3.5a.75.75 0 0 1 .75-.75Zm0 6.5a.875.875 0 1 1 0-1.75.875.875 0 0 1 0 1.75Z"></path>
    </svg>
    <span>Important</span>
  </div>
  ...
  <ul style="margin: 0; padding-left: 20px; list-style-type: disc;">
    <li style="margin-bottom: 8px;"><strong>Date limite pour l'inscription:</strong> le mardi 2 juin, 2026</li>
    <li style="margin-bottom: 8px;"><strong>Apportez votre dîner</strong></li>
    <li style="margin-bottom: 0;"><strong>Aucun autobus n'est prévu,</strong> les cadets peuvent :
      <!-- Nested List -->
      <ul style="margin-top: 6px; padding-left: 20px; list-style-type: circle;">
        <li style="margin-bottom: 6px;">se rendre directement sur place pour 11h30 et revenir par leurs propres moyens, sans passer par le 52 Saint-Rosaire</li>
        <li style="margin-bottom: 0;">ou se rendre au 52 Saint-Rosaire pour 10h30 afin de participer au covoiturage</li>
      </ul>
    </li>
  </ul>
