...
## Soirée d’instruction 11 septembre
- **Qui :** tous
...
- **Tenue pour tous :** C5 pour les anciens
- Pour les anciens, si cela n’a pas été fait la semaine passée, venez avec un parent afin de remplir les formulaires de validation annuelle et le code de conduite sur place. Les parents pourront quitter après environ 1 heure.
- Pour les nouveaux, venez avec un parent, votre certificat de naissance et votre carte d’assurance-maladie. Les parents peuvent quitter après avoir rempli les formulaires.
...
## Habillement
L’habillement ce mercredi est pour les cadets ayant un rendez-vous seulement.
